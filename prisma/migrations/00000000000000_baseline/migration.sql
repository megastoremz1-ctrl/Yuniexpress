...
-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'OUT_OF_STOCK', 'DISCONTINUED');
...
CREATE TABLE "Product" (
    ...
    "priceMZN" DOUBLE PRECISION NOT NULL,
    "originalPriceMZN" DOUBLE PRECISION,
...
CREATE TABLE "Order" (
    ...
    "userId" TEXT NOT NULL,
    "subtotalMZN" DOUBLE PRECISION NOT NULL,
    "shippingMZN" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "discountMZN" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "totalMZN" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "Coupon" (
    ...
    "minOrderMZN" DOUBLE PRECISION,
    "maxDiscountMZN" DOUBLE PRECISION,
    "usageLimit" INTEGER,
...
CREATE TABLE "ExchangeRate" (
    ...
    "toCurrency" TEXT NOT NULL DEFAULT 'MZN',
...
-- CreateIndex
CREATE INDEX "Product_priceMZN_idx" ON "Product"("priceMZN");
